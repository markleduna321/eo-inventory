...
export default function CreatePartsSection() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const submitData = {
                ...formData,
                initial_stock: formData.items.length > 0 ? formData.items.length : 0
            }
            ...
            <Modal isOpen={isModalOpen} onClose={closeModal}>
                <div className="bg-white max-h-[90vh] flex flex-col">
                    ...
                    <div className="flex-1 overflow-y-auto px-4 sm:px-6">
                        <form id="create-part-form" className="space-y-4 py-4" onSubmit={handleSubmit}>
                                    {/* Basic Information */}
                                    ...
                                    <div>
                                        ...
                                        {formData.items.length === 0 && (
                                            <p className="text-sm text-gray-500">
                                                ...
                                                Items added here will be included when creating the part.
                                                All items will use the same unit price and supplier specified above.
                                            </p>
                                        )}
                                    </div>
